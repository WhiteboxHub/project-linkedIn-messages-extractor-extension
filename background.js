  ...
  "contacts": [
    {
      ...
      "company_name": "string (Extract the recruiter's own agency/employer company from contactHeadline, e.g. 'Innovapath') or null",
      "job_title": "string (Extract this person's job title from contactHeadline ONLY. Do NOT extract the job title they are hiring for) or null",
      "city": "string or null",
  ...
  "positions": [
    {
      ...
      "title": "string (job title they are hiring for, e.g. 'AI Engineer', max 500 chars)",
      "company": "string (name of the company where the position is available, e.g. 'Accenture', max 255 chars)",
